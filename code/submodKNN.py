...
mu = 4.
iters = 500
pt.append(ROC(SS, S, n=n, d=2, k=k**2, mu=mu, iters=iters, rho = k))
...
mu = 4.
iters = 500
pt.append(ROC(WD, S, n=n, d=2, k=k**2, mu=mu, iters=iters, rho = k))
...
mu = 4.
iters = 500
pt.append(ROC(MD, S, n=n, d=2, k=k**2, mu=mu, iters=iters, rho = k))

pt.append(pickle.load(open('data/submod_knn_n=225_mu=4.pt','r')))
